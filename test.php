...
<body>
 ...
 <?php 
  ...
  <table name="cart">
    ...
    <tr class="line_items">
       <td><input type="text"  name="pname[]" class="form-control pname"  placeholder="Enter Name"></td>
      <td><input type="text"  name="qty[]" id="qty" class="form-control"  placeholder="Enter Quantity"></td>
